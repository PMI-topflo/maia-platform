...
export const MANXI_RULES: string[] = [
  ...
  'MAINTENANCE ASSESSMENTS: due quarterly (January, April, July, October). Assessments and installments not paid when due are subject to a $25.00 late fee PER QUARTER — not a monthly charge. (Amendment to Rule 56, recorded May 22, 1997, Broward County Official Records Book 26543, Page 0575.)',
