...
export const DOC_SPECS: Record<string, DocSpec> = {
  ...
  insurance_ho6:         { key: 'insurance_ho6',         label: 'Unit HO-6/DP-3 insurance',     expects: 'a unit-owner condominium insurance declaration where the named insured is an individual unit owner (not the association) — accept EITHER an HO-6 policy OR a Dwelling Fire "DP-3 Unit Owners" / "Unit Owners Special Form" policy (e.g. Citizens\' DP-3 Unit Owners form); judge by the coverages present (dwelling/unit-owners coverage, personal property, liability), not the form name on the declarations page', expiry: true },
