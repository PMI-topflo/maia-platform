...
export const INTL_DOCS_CONTENT: Record<IntlDocsLang, IntlDocsContent> = {
  en: {
    ...
    cpaBullets: [
      ...
      'State explicitly whether the applicant’s gross annual income meets or does not meet the minimum income requirement stated in the Association’s Application Guide.',
  ...
  es: {
    ...
    cpaBullets: [
      ...
      'Indicar explícitamente si el ingreso bruto anual del solicitante cumple o no con el requisito de ingreso mínimo establecido en la Guía de Solicitud de la Asociación.',
  ...
  pt: {
    ...
    cpaBullets: [
      ...
      'Declarar explicitamente se a renda bruta anual do candidato atende ou não ao requisito de renda mínima estabelecido no Guia de Solicitação da Associação.',
  ...
  fr: {
    ...
    cpaBullets: [
      ...
      'Indiquer explicitement si le revenu brut annuel du candidat respecte ou non l’exigence de revenu minimum indiquée dans le Guide de Candidature de l’Association.',
  ...
  ht: {
    ...
    cpaBullets: [
      ...
      'Deklare klèman si revni brit anyèl aplikan an satisfè oswa pa satisfè kondisyon revni minimòm ki make nan Gid Aplikasyon Asosyasyon an.',
  ...
  he: {
    ...
    cpaBullets: [
      ...
      'לציין באופן מפורש האם ההכנסה השנתית ברוטו של המבקש עומדת או אינה עומדת בדרישת ההכנסה המינימלית הנקובה במדריך ההגשה של האגודה.',
  ...
  ru: {
    ...
    cpaBullets: [
      ...
      'Прямо указать, соответствует ли валовой годовой доход заявителя минимальному требованию к доходу, указанному в Руководстве по подаче заявки Ассоциации, или нет.',
