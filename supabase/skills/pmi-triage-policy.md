---
name: PMI Triage Policy
description: Office hours, response-time SLAs, and emergency triage. Apply this when troubleshooting in another customer skill did not resolve the issue, or when a customer asks "when will someone come?" / "is this an emergency?".
audience: customer
---
...
- Don't quote pricing or repair cost — staff handles that.
