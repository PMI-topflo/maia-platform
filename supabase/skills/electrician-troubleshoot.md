---
name: Electrician Troubleshoot
description: Customer-facing troubleshooting for electrical complaints. Triages safety hard, allows only the safest resets (breaker, GFCI), and otherwise gathers symptoms for a licensed electrician.
audience: customer
---
...
- Anything involving aluminum wiring, knob-and-tube wiring, or any wire visibly outside a junction box.
