...
const QUICK_LINKS: Array<{ label: string; href: string; desc: string; emoji: string; external?: boolean }> = [
  ...
  { emoji: '✅', label: 'Visitors to identify', href: '/admin/pending-approvals',  desc: 'Unidentified visitors' },
  { emoji: '📋', label: 'Applications',      href: '/admin/pre-apply',          desc: 'Lease + purchase apps' },
