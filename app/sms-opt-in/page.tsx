...
export const metadata = {
  title: 'Text Message Sign-Up — PMI Top Florida Properties',
  description: 'Opt in to receive account, maintenance, and community SMS updates from PMI Top Florida Properties.',
}
