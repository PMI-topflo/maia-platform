...
_Last updated: **2026-09-13**. Status key: ✅ Live · 🟡 Partial · 🔴 Not built · ⚠️ Blocked · ⛔ Decided off._
...
5. Lease non-renewal escalation (independent of 1–4, can ship anytime). 🟡 **Grace-window half shipped 2026-09-12** (PR #883, `lib/lease-renewal-rule.ts`): a renewal requested > 30 days after the previous lease end opens as a new lease (screening + fee). Still 🔴: the T-30 escalation notice, 15-day violation-fee clock, staff screen, red T+30 flag.
